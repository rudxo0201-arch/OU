...
export const DEFAULT_LAYOUT_CONFIG: LayoutConfig = {
  ...
  textStyles: {
    ...
    secondary: { fontSize: 12, fontWeight: 400, color: 'var(--ou-text-dimmed)', lineHeight: 1.5 },
    tertiary:  { fontSize: 10, fontWeight: 400, color: 'var(--ou-text-dimmed)', lineHeight: 1.5 },
  },
  grid: {
