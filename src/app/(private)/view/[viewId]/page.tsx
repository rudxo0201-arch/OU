...
import { OuButton, OuCard, OuModal } from '@/components/ds';
    ...
    <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', background: 'var(--ou-bg)', paddingTop: 52, padding: '52px 116px 0' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <OuButton variant="ghost" size="sm" onClick={() => router.back()} style={{ padding: '4px 8px' }}>
            ←
          </OuButton>
        ...
        <div style={{ position: 'relative' }}>
          <OuButton variant="ghost" size="sm" onClick={() => setShowShare(!showShare)} style={{ padding: '4px 10px' }}>
            ⋯
          </OuButton>
      ...
      <div style={{ flex: 1, overflow: 'auto' }}>
        {ViewComponent ? (
          <>
            {nodes.length === 0 && <EmptyHint viewType={viewType} onOrb={() => router.push('/home')} />}
      ...
      {/* 위젯 추가 완료 모달 */}
      <OuModal open={addedToHome} onClose={() => setAddedToHome(false)} title="홈에 추가됨">
