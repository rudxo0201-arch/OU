      ...
      while (true) {
        ...
        for (const line of chunk.split('\n')) {
          ...
          try {
            ...
            if (data.textFinal) { accumulated = data.textFinal; updateMessage(assistantId, { content: accumulated, isStatus: false }); }
            if (data.done) {
              ...
              if (data.title) updateMessage(assistantId, { title: data.title });
            }
            if (data.nodeCreated) {
