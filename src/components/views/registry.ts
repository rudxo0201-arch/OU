...
export const VIEW_META: Record<string, ViewMeta> = {
  ...
  'schedule-today':    { previewOnClick: false, category: 'inline' },
  'schedule-tomorrow': { previewOnClick: false, category: 'inline' },
  'schedule-week':     { previewOnClick: false, category: 'inline' },
  'schedule-around':   { previewOnClick: false, category: 'inline' },
  'finance-amount':    { previewOnClick: false, category: 'inline' },
  'finance-balance':   { previewOnClick: false, category: 'inline' },
  ...
  'task-deadline':     { previewOnClick: false, category: 'inline' },
  'task-today':        { previewOnClick: false, category: 'inline' },
  'task-overdue':      { previewOnClick: false, category: 'inline' },
  'task-week':         { previewOnClick: false, category: 'inline' },
  'task-check-simple': { previewOnClick: false, category: 'inline' },
  'idea-card':         { previewOnClick: false, category: 'inline' },
  ...
  'knowledge-note':    { previewOnClick: false, category: 'inline' },
  'media-card':        { previewOnClick: false, category: 'inline' },
  'media-rating':      { previewOnClick: false, category: 'inline' },
  'dev-note':          { previewOnClick: false, category: 'inline' },
  'location-pin':      { previewOnClick: false, category: 'inline' },
  'youtube-card':      { previewOnClick: false, category: 'inline' },
  'youtube-timestamp': { previewOnClick: false, category: 'inline' },
  'health-log':        { previewOnClick: false, category: 'inline' },
  'health-symptom':    { previewOnClick: false, category: 'inline' },
